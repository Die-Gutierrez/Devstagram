...
<?php $__env->startSection('contenido'); ?>
    <div class="flex flex-col-reverse p-5 items-center lg:flex-row lg:justify-center">
        <div class="basis-2/5 lg:basis-3/5">
            ...
            <a href="<?php echo e(route('registro.index')); ?>" class="inline-flex items-center justify-center px-5 py-3 mr-3
            ...
            <a href="<?php echo e(route('login.index')); ?>" class="inline-flex items-center justify-center px-5 py-3 text-base font-medium
