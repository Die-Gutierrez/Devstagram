<div>
    <section class="relative">
        ...
        <!--[if BLOCK]><![endif]--><?php if($busquedaEstaClickeada && count($usuarios)): ?>
            <div class="absolute w-full">
                <ul class="shadow-md mt-2 ms-3   bg-white relative "
                    ...
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $usuarios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $usuario): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li>
                            <a href="<?php echo e(route('publicaciones.index', $usuario)); ?>"
                               class="p-3 flex gap-x-3 cursor-pointer hover:bg-gray-50 ">
                                <img
                                    src="<?php echo e(($usuario->imagen) ? asset("perfiles/$usuario->imagen"): asset('img/usuario.svg' )); ?>"
...
<?php /**PATH C:\Users\snaisdev\Documents\netdev-master\resources\views/livewire/buscar-usuarios.blade.php ENDPATH**/ ?>